...
function ProjectsMain() {
  const projectCards = [{ content: (<ProjectCard name='A.I. Tic-Tac-Toe' description='Exploring the minimax, alpha-beta-pruning, and expectiminimax algorithms with a 3x3 board.' stack={["React", "Express", "PostgreSQL"]} githubLink='https://github.com/devangmalhotra/ai-tic-tac-toe' demoLink='https://devangmalhotra-tic-tac-toe.netlify.app/' image={ticTacToeScreenshot} index={0}/>) }, { content: (<ProjectCard name='Student Housing Dashboard' description='Understanding the student housing industry in some of the major areas in Ontario.' stack={["React", "Express", "MySQL", "Puppeteer"]} githubLink='https://github.com/devangmalhotra/student-housing-industry-analysis' demoLink='https://student-housing-industry-analysis.netlify.app/' image={housingDashboardScreenshot} index={1}/>) }, { content: (<ProjectCard name='Calculator' description='Full-stack calculator application.' stack={["HTML", "Tailwind CSS", "JavaScript"]} githubLink='https://github.com/devangmalhotra/Calculator' demoLink='https://calculator-devangmalhotra.netlify.app/' image={calculatorScreenshot} index={2}/>) }, { content: (<ProjectCard name='Musicube' description='YouTube to .mp3 converter (currently only runs locally).' stack={["HTML", "CSS", "JavaScript"]} githubLink='https://github.com/devangmalhotra/musicube' image={musicubeScreenshot} index={3}/>) }, { content: (<ProjectCard name='Student Marking Application' description='Visualizes the grades in a class (data provided beforehand).' stack={["VBA"]} githubLink='https://github.com/devangmalhotra/student-marking-application' image={studentMarkingApplicationScreenshot} index={4}/>) }]
